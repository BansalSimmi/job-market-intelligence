#Quick inspection of the two new datasets before merging into the pipeline.

import pandas as pd, sys
sys.stdout.reconfigure(encoding='utf-8')

# DS3: ai_job_market_insights 
print("=" * 60)
print("DS3: ai_job_market_insights.csv")
print("=" * 60)
ds3 = pd.read_csv(r"data/raw/ai_job_market_insights.csv")
...
# DS4: postings (LinkedIn) 
print()
print("=" * 60)
print("DS4: postings.csv  [first 5 rows only — file is 500 MB]")
print("=" * 60)
ds4 = pd.read_csv(r"data/raw/postings.csv", nrows=5)
print(f"Columns ({len(ds4.columns)}): {list(ds4.columns)}")
print()
print(ds4.head(3).to_string())
print()
# Read more rows to get unique values
ds4_sample = pd.read_csv(r"data/raw/postings.csv", nrows=5000)
print(f"\nSample (5000 rows):")
