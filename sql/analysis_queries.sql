...
-- Run in pgAdmin or DBeaver after loading data.


-- Q1: Top 10 highest-paying cities
SELECT
    city,
...
-- Q2: Top 10 highest-paying roles
SELECT
    job_role,
    ROUND(AVG(salary_inr), 0)  AS avg_salary_inr,
...
-- Q4: Does CGPA matter for hiring?
SELECT
    CASE
...
-- Q6: Top skills among hired candidates
WITH skill_rows AS (
    SELECT
...
-- Q7: Fresher offer vs market salary by role
SELECT
    fa.job_role,
...
-- Q8: Hiring funnel — stage drop-off
SELECT
    hiring_stage,
    COUNT(*)                                            AS candidates,
...
-- Q9: Remote vs on-site by sector
SELECT
    sector,
    work_type,
    COUNT(*)                                                                      AS count,
